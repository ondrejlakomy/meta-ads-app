...
Python CLI for Facebook & Instagram ads via Marketing API **v25.0**. Version 2.5.0, 48 commands. Czech user docs in [README.md](README.md).
...
- **Conversions (read-only)**: `pixels`, `custom-conversions`, `comments`
